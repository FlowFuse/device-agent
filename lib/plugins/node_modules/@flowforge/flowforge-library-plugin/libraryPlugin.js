/*
 * IMPORTANT
    * This plugin is a duplicate of the one in nr-launcher/lib/storage/libraryPlugin.js
...
module.exports = function (RED) {
    ...
    class FFTeamLibraryPlugin {
        constructor (config) {
            ...
            const { applicationID, projectID, libraryID, token } = config
            if (!projectID && !applicationID) {
                throw new Error('Missing required configuration property: projectID or applicationID are required')
            }
            if (!libraryID) {
    ...
    RED.plugins.registerPlugin(PLUGIN_TYPE_ID, {
        ...
        class: FFTeamLibraryPlugin,
        onadd: () => {
            RED.log.info('FlowFuse Team Library Plugin loaded')
        }
    })
}
