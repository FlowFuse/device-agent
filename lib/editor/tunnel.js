            ...
            socket.on('message', async (message) => {
                ...
                if (request.ws) {
                    ...
                    if (request.id && request.url) {
                        ...
                        const options = {
                            [thisTunnel.localWSProtocol]: { rejectUnauthorized: false }
                        }
                        const tunnelledWSClient = newWsConnection(localWSEndpoint, options)
                    ...
                    got(fullUrl, {
                        ...
                        body: request.body,
                        throwErrors: false,
                        [thisTunnel.localProtocol]: { rejectUnauthorized: false }
                    }).then(response => {
