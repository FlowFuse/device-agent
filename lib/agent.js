...
class Agent {
    ...
    async setState (newState) {
        ...
        if (newState && (utils.hasProperty(newState, 'ownerType') === false || newState.ownerType === null)) {
        ...
        if (newState === null) {
            ...
            if (unknownOrStopped && inhibitUpdates && snapShotUpdatePending && (projectUpdatePending || applicationUpdatePending)) {
                ...
                if (utils.hasProperty(newState, 'application') && (!this.currentSnapshot || newState.application !== this.currentApplication)) {
                    ...
                    updateSnapshot = true
                    updateSettings = true
                } else if (utils.hasProperty(newState, 'project') && (!this.currentSnapshot || newState.project !== this.currentProject)) {
                    info('New instance assigned')
                    this.currentApplication = null
                    this.currentProject = newState.project
                    // Update everything
